...
class ChecklistFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'activity_id' => ['type' => 'integer', 'length' => 10, 'default' => null, 'null' => false, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'checklist_activity_id_fkey' => ['type' => 'foreign', 'columns' => ['activity_id'], 'references' => ['activities', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
